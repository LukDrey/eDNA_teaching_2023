---
title: "Mycology Master's module (Evo-3-VS, Evo-3-P) eDNA pipeline 2023"
 ...
 * [R(<https://www.r-project.org/>) (and [RStudio](https://posit.co/products/open-source/rstudio/)): statistical software environment
 ### Specific functions in R come in "packages" that we need to install and load into our working environment. 
